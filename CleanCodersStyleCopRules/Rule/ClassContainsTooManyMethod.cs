...
namespace CleanCodersStyleCopRules.Rule
{
    ...
    public class ClassContainsTooManyMethod : CustomRuleBase
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="ClassContainsTooManyMethod"/> class.
        /// </summary>
        public ClassContainsTooManyMethod()
        {
        ...
        public override bool ValidateElement(CsElement element, CsElement parentElement, CleanCoderAnalyzer context)
        {
            ...
            {
                context.AddViolation(element, element.LineNumber, this.RuleName, element.Declaration.Name, nombreMethod, context.AnalyserSetting[RuleSettingName]);
            }
