...
namespace CleanCodersStyleCopRules.Rule
{
    ...
    /// </summary>
    public class VariableNameIsNotPlural : CustomRuleBase
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="VariableNameIsNotPlural"/> class.
        /// </summary>
        public VariableNameIsNotPlural()
        {
        ...
        public override bool ValidateExpression(Expression expression, Expression parentExpression, Statement parentStatement, CsElement parentElement, CleanCoderAnalyzer context)
        {
            ...
            this.ProcessVariableName(parentElement, variableDeclaratorExpression.Identifier.Text, variableDeclaratorExpression.ParentVariable.Type.Text, expression.Location.LineNumber, context);
        ...
        private void ProcessParameter(CsElement element, IEnumerable<Parameter> parameters, CleanCoderAnalyzer context)
        {
            ...
            {
                this.ProcessVariableName(element, parameter.Name, parameter.Type.Text, parameter.LineNumber, context);
            }
        }
        ...
        /// </param>
        [SuppressMessage("CleanCodersStyleCopRules.CleanCoderAnalyzer", "CC0042:MethodHasTooManyArgument", Justification = "It's a delegate for Analyzer.VisitElement.")]
        private void ProcessVariableName(CsElement element, string variableName, string variableTypeDefinition, int lineNumber, CleanCoderAnalyzer context)
        {
            Param.AssertNotNull(element, "element");
            ...
            {
                context.AddViolation(element, lineNumber, this.RuleName, variableName);
            }
        }
