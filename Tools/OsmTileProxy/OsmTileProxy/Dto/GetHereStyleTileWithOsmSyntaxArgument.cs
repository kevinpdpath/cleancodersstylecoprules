// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetHereStyleTileWithOsmSyntaxArgument.cs" company="Acme">
...
{
    /// <summary>
    /// DTO used with the GetHereStyleTileWithOsmSyntax function of the OSM style controller.
    /// </summary>
    public class GetHereStyleTileWithOsmSyntaxArgument
    {
        ...
        /// <summary>
        /// Gets or sets the here app code key.
        /// </summary>
        public string HereAppCodeKey { get; set; }

        /// <summary>
        /// Gets or sets the here app id key.
        /// </summary>
        public string HereAppIdKey { get; set; }
