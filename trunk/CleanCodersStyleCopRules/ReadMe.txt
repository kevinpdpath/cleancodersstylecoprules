...
Other than that, I decided to use string properties instead of CollectionProperty because StyleCop does not implement a default value for Collections.
...
There are 3 DLLs being referenced in the two projects. StyleCop.dll, StyleCop.CSharp.dll and nunit.framework. The two StyleCop references are the DLL that are
installed when you install StyleCop on your machine. You can simply copy your installation DLL over the ones found inside the lib directory or redo the
references to point directly to your StyleCop installed DLL. Same goes for the NUnit DLL.
...
Jean.Francois.Talbot@gmail.com
