...
namespace CleanCodersStyleCopRules.Rule
{
    ...
    public static class ClassContainsTooManyMethod
    {
        ...
        public static bool Validate(CsElement element, CsElement parentElement, CleanCoderAnalyzer context)
        {
            ...
            if (nombreMethod > (int)context.AnalyserSetting[PropertySettingName])
            {
                context.AddViolation(element, element.LineNumber, RuleName, element.Declaration.Name, nombreMethod, context.AnalyserSetting[PropertySettingName]);
            }
